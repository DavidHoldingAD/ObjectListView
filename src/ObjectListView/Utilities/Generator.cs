...
public class Generator : IGenerator
{
	...
	static public void GenerateColumns(ObjectListView olv, IEnumerable enumerable) => Generator.GenerateColumns(olv, enumerable, false);
	...
	/// <param name="olv">The ObjectListView to modify</param>
	/// <param name="type">The model type whose attributes will be considered.</param>
	static public void GenerateColumns(ObjectListView olv, Type type) => Generator.Instance.GenerateAndReplaceColumns(olv, type, false);
	...
	/// <param name="type">The model type whose attributes will be considered.</param>
	/// <param name="allProperties">Will columns be generated for properties that are not marked with [OLVColumn].</param>
	static public void GenerateColumns(ObjectListView olv, Type type, bool allProperties) => Generator.Instance.GenerateAndReplaceColumns(olv, type, allProperties);
	...
	/// <param name="type"></param>
	/// <returns>A collection of OLVColumns matching the attributes of Type that have OLVColumnAttributes.</returns>
	static public IList<OLVColumn> GenerateColumns(Type type) => Generator.Instance.GenerateColumns(type, false);
	...
	{
		Munger childrenGetter = new(pinfo.Name);
