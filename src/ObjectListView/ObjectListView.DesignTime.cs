...
public class ObjectListViewDesigner : ControlDesigner
{
	...
	protected override void PreFilterProperties(IDictionary properties)
	{
		...
		List<string> unwantedProperties = new(new string[] {
	...
	protected override void PreFilterEvents(IDictionary events)
	{
		...
		List<string> unwanted = new(new string[] {
			"AfterLabelEdit",
			"BeforeLabelEdit",
			"DrawColumnHeader",
			"DrawItem",
	...
	public override ICollection AssociatedComponents
	{
		get
		{
			ArrayList components = new(base.AssociatedComponents);
	...
	private class ListViewActionListAdapter : DesignerActionList
	{
		...
		public void InvokeColumnsDialog() => EditValue(designer, base.Component, "Columns");
