...
public class GraphicAdornment
{
	...
	public System.Drawing.ContentAlignment AdornmentCorner { get; set; } = System.Drawing.ContentAlignment.MiddleCenter;
	...
	[Browsable(false),
	 DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
	public System.Drawing.ContentAlignment ReferenceCorner { get; set; } = System.Drawing.ContentAlignment.MiddleCenter;
...
public class TextAdornment : GraphicAdornment
{
	...
	protected virtual Rectangle CalculateTextBounds(Graphics g, Rectangle r, string s)
	{
		...
		Size size = new(1 + (int)sizeF.Width, 1 + (int)sizeF.Height);
