...
public static class Locators
{
	...
	/// </summary>
	public static IPointLocator At(int x, int y) => new FixedPointLocator(new Point(x, y));

	public static IPointLocator At(Point pt) => new FixedPointLocator(pt);
	...
	public static IPointLocator SpriteAligned(Corner corner) => Locators.SpriteAligned(corner, corner, Point.Empty);
	...
	/// <returns></returns>
	public static IPointLocator SpriteAligned(Corner corner, Point offset) => Locators.SpriteAligned(corner, corner, offset);
	...
	/// <returns>A point locator</returns>
	public static IPointLocator SpriteAligned(Corner spriteCorner, Corner animationCorner) => Locators.SpriteAligned(spriteCorner, animationCorner, Point.Empty);
	...
	/// <param name="offset"></param>
	/// <returns></returns>
	public static IPointLocator SpriteAligned(Corner spriteCorner, Corner animationCorner, Point offset) => new AlignedSpriteLocator(
	...
	/// <returns>A point locator</returns>
	public static IPointLocator SpriteAligned(Corner spriteCorner, float proportionX, float proportionY) => Locators.SpriteAligned(spriteCorner, proportionX, proportionY, Point.Empty);
	...
	/// <param name="offset"></param>
	/// <returns></returns>
	public static IPointLocator SpriteAligned(Corner spriteCorner, float proportionX, float proportionY, Point offset) => new AlignedSpriteLocator(
	...
	/// </summary>
	public static IRectangleLocator At(int x, int y, int width, int height) => new FixedRectangleLocator(new Rectangle(x, y, width, height));

	public static IRectangleLocator At(Rectangle r) => new FixedRectangleLocator(r);

	/// <summary>
	/// Create a Locator that gives the bounds of the animation
	/// </summary>
	/// <returns></returns>
	public static IRectangleLocator AnimationBounds() => new AnimationBoundsLocator();
	...
	/// <param name="y"></param>
	/// <returns></returns>
	public static IRectangleLocator AnimationBounds(int x, int y) => new AnimationBoundsLocator(x, y);

	/// <summary>
	/// Create a Locator that gives the bounds of the sprite
	/// </summary>
	/// <returns></returns>
	public static IRectangleLocator SpriteBounds() => new SpriteBoundsLocator();
	...
	/// <param name="y"></param>
	/// <returns></returns>
	public static IRectangleLocator SpriteBounds(int x, int y) => new SpriteBoundsLocator(x, y);
	...
	/// <param name="corner"></param>
	/// <returns></returns>
	public static IPointLocator SpriteBoundsPoint(Corner corner) => new PointOnRectangleLocator(new SpriteBoundsLocator(), corner);
	...
	/// <param name="proportionY"></param>
	/// <returns></returns>
	public static IPointLocator SpriteBoundsPoint(float proportionX, float proportionY) => new PointOnRectangleLocator(new SpriteBoundsLocator(), proportionX, proportionY);
	...
	/// <param name="corner"></param>
	/// <returns></returns>
	public static IPointLocator AnimationBoundsPoint(Corner corner) => new PointOnRectangleLocator(new AnimationBoundsLocator(), corner);
	...
	/// <returns></returns>
	public static IPointLocator AnimationBoundsPoint(Corner corner, int xOffset, int yOffset) => new PointOnRectangleLocator(new AnimationBoundsLocator(), corner, new Point(xOffset, yOffset));
	...
	/// <param name="proportionY"></param>
	/// <returns></returns>
	public static IPointLocator AnimationBoundsPoint(float proportionX, float proportionY) => new PointOnRectangleLocator(new AnimationBoundsLocator(), proportionX, proportionY);
}
