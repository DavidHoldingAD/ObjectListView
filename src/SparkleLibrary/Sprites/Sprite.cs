...
public class Sprite : Animateable, ISprite
{
	...
	{
		Init();
		ReferenceBoundsLocator = new AnimationBoundsLocator();
		ReferenceBoundsLocator.Sprite = this;
	}
	...
	/// </summary>
	public virtual Rectangle OuterBounds => Animation.Bounds;
	...
	{
		get { return ReferenceBoundsLocator.GetRectangle(); }
		set { ReferenceBoundsLocator = new FixedRectangleLocator(value); }
	}
	...
	public override bool Tick(long elapsed)
	{
		...
		foreach (EffectControlBlock cb in ControlBlocks)
		{
		...
		return (ControlBlocks.Exists(delegate (EffectControlBlock cb)
		{ return !cb.Stopped; }));
	}
	...
	protected void ApplyFixedLocations()
	{
		if (FixedBounds != null)
		{
			Bounds = FixedBounds.GetRectangle();
		}
		else
			if (FixedLocation != null)
		{
			Location = FixedLocation.GetPoint();
		}
	}
	...
	public override void Reset()
	{
		...
		List<EffectControlBlock> sortedBlocks = new(ControlBlocks);
	...
	public void Add(IEffect effect) => Add(0, 0, effect);
	...
	/// <param name="effect"></param>
	public void Add(long startTick, IEffect effect) => Add(startTick, 0, effect);
	...
	{
		EffectControlBlock cb = new(startTick, duration, effect);
		effect.Sprite = this;
		ControlBlocks.Add(cb);
	}
	private List<EffectControlBlock> ControlBlocks = new();
	...
	protected virtual void ApplyState(Graphics g)
	{
		...
		if (Spin != 0)
		{
			...
			m.RotateAt(Spin, spinCentre);
		}

		m.Translate((float)Location.X, (float)Location.Y);
	...
	/// </summary>
	/// <param name="g">The graphic to be configured</param>
	protected virtual void UnapplyState(Graphics g) => g.ResetTransform();
	...
	protected class EffectControlBlock
	{
		...
		public long ScheduledEndTick => StartTick + Duration;
